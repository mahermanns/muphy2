...
void Parameter::init() {
  ...
  // Liu et al. 2020
  // Magnetospheric Multiscale (MMS) Observations
  // of Magnetic Reconnection in Foreshock Transients
  // in above paper: twice the resolution compared to this file
  ...
  setup_var["psi"] = 0.1;
  setup_var["guide_field"] = .1; // also in the paper: same setup with gf = 1.
