...
void Parameter::init() {
  ...
  species[kElectron].vb[0] = -5.;
  species[kElectron].vb[1] = -5.;
  species[kElectron].vb[2] = -5.;

  species[kElectron].ve[0] = 5.;
  species[kElectron].ve[1] = 5.;
  species[kElectron].ve[2] = 5.;
