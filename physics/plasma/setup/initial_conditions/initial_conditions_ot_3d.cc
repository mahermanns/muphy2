...
void Parameter::init() {
  ...
  species[kIon].q = 1.;
  species[kElectron].m = 0.04; // in dissertation D. Groselj: 1/64
  species[kIon].m = 1.;
  species[kElectron].T0 = .25;
  species[kIon].T0 = .25;
  c0 = 14.15; // c = 2.83/sqrt(m_e) -> if (m_e==25); c=14.15, if (m_e==1/64) c = 22.64
  mu0 = 1.;
  eps0 = 1./(c0*c0);

  // setup specific
  setup = "orszag_tang_3d";
  setup_var["n_bg"] = 1.;
  setup_var["L"] = 17.;
  setup_var["L_z"] = 42.4;
  setup_var["delta_u"] = 0.4;
  setup_var["cross_helicity"] = -0.45; // in dissertation D. Groselj chosen as 0 (MHD regime)
                                       // or -0.45 (kinetic regime); it must be abs(cross_helicity) <= 0.5
  ...
  species[kElectron].vb[0] = -17.5; // for m=0.04
  species[kElectron].vb[1] = -17.5;
  species[kElectron].vb[2] = -17.5;
  species[kElectron].ve[0] =  17.5;
  species[kElectron].ve[1] =  17.5;
  species[kElectron].ve[2] =  17.5;
  species[kIon].vb[0] = -4.;
  species[kIon].vb[1] = -4.;
  species[kIon].vb[2] = -4.;
  species[kIon].ve[0] =  4.;
