...
void Parameter::init() {
  ...
  species[kIon].vb[0] = -4.5;
  species[kIon].vb[1] = -4.5;
  species[kIon].vb[2] = -4.5;

  species[kIon].ve[0] = 4.5;
  species[kIon].ve[1] = 4.5;
  species[kIon].ve[2] = 4.5;

  // time
  t_end = (xe[1]-xb[1])*5.; // 2.5 t_A = 2.5 * L_y
  ...
  bd_cond_Q_h[1] = "ssaapp"; // xxy
  bd_cond_Q_h[2] = "sssspp"; // xxz
  bd_cond_Q_h[3] = "aasspp"; // xyy
  bd_cond_Q_h[4] = "aaaapp"; // xyz
  bd_cond_Q_h[5] = "aasspp"; // xzz
  bd_cond_Q_h[6] = "ssaapp"; // yyy
  bd_cond_Q_h[7] = "sssspp"; // yyz
  bd_cond_Q_h[8] = "ssaapp"; // yzz
